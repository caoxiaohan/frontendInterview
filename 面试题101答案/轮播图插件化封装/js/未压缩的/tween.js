        ...
        if (typeof effect === "number") {
            switch (effect) {
                case 0:
                    ...
                    break;
                case 1:
                    tempEffect = tweenEffect.Circ.easeInOut;
                    break;
                case 2:
                    tempEffect = tweenEffect.Elastic.easeOut;
                    break;
                case 3:
                    tempEffect = tweenEffect.Back.easeOut;
                    break;
                case 4:
                    tempEffect = tweenEffect.Bounce.easeOut;
                    break;
                case 5:
                    tempEffect = tweenEffect.Expo.easeIn;
            }
